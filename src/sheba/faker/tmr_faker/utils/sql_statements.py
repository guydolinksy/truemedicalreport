execute_set_patient_admission = """execute sbwnd81c.chameleon.dbo.faker_RoomPlacmentPatient_admission {}"""

execute_set_hospitalized_decision = """execute sbwnd81c.chameleon.dbo.faker_decision {}"""

execute_set_responsible_doctor = """execute sbwnd81c.chameleon.dbo.faker_ResponsibleDoctor {}"""
