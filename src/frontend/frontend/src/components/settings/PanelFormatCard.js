...
const PanelFormatCardInner = () => {
    ...
    return user.is_admin && <Card title={'הגדרות הצגת פרטי מחלקה'}>
        <RenderObject name={'components'} content={value.components} path={["components"]}
...
export const PanelFormatCard = () => {
    ...
    return <panelDataContext.Provider url={`/api/settings/views/${viewType}/${view}/modes/${mode}/panel/format`}>
