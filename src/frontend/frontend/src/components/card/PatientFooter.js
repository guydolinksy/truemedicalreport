    ...
    <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#f5f5f5' }}>
      {(value.treatment.doctors.length > 0 || Object.keys(value.referrals).length > 0 || unpairedNotes.length > 0) && (
        ...
        >
          ...
          {Object.keys(value.referrals).length > 0 && (
            <div
              style={{
                display: 'flex',
                overflow: 'hidden',
            ...
            >
              {Object.values(value.referrals)
                .filter((ref) => !ref.completed)
                .map((ref, index) => (
          ...
          {unpairedNotes.length > 0 && (
            <NoteTooltip notes={unpairedNotes.map((note) => notes[note])}>
              <div>
                <FileAddOutlined />
              </div>
            </NoteTooltip>
