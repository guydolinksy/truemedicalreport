...
const AllSurgeries = ({patientId}) => {
    ...
    return surgeries.length ?
        <>
            ...
            <div>
                <Button type={'text'} onClick={() => showModal(patientId)}>הצג את כלל הניתוחים של המטופל</Button>
            </div>
        </>
        :
...
export const Results = () => {
    ...
    return <Table size={"small"} pagination={filteredData.length > 100 ? {pageSize: 100} : false}
