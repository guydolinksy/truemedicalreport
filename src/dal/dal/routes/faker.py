...
faker_router = APIRouter(tags=[DAL_FAKER_TAG_NAME])


@faker_router.post("/wings")
def fake_wings(mongo: MongoClient = Depends(mongo_client)):
    ...
    init_db(
        wings=[
            ...
            {"key": "אגף הולכים", "name": "אגף הולכים", "department": "er", "blocks": []},
            {"key": "חדר הלם", "name": "חדר הלם", "department": "er", "blocks": []},
        ],
        mongo=mongo,
    )
