...
@query.field('getViewFilters')
async def resolve_get_filters(_, info: GraphQLResolveInfo, view_type: str, key: Optional[str] = None,
                              department: Optional[str] = None):
    medical_dal_: MedicalDal = info.context['medical_dal']

    return dict(success=True, filters=await medical_dal_.get_wing_filters(view_type, key, department))
...
async def resolve_get_patients(_, info: GraphQLResolveInfo,
                               department: Optional[str] = None, wing: Optional[str] = None, bed: Optional[str] = None,
                               view_type: Optional[str] = None, view: Optional[str] = None,
    ...
    ps = await medical_dal_.get_patients(department, wing, bed, view_type, view, oid, members=members)
